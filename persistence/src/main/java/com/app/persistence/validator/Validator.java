...
public interface Validator<T> {
    ...
    static boolean containsNotOnlyWhitespacesOrUpperCaseCharacters(String word) {
        return !word.matches("[A-Z\\s]+");
    }

    static boolean containNotOnlyWhitespacesOrUpperCaseCharacters(List<String> words) {
        return words.stream()
                .anyMatch(Validator::containsNotOnlyWhitespacesOrUpperCaseCharacters);
    }
